...
function Inventory() {
    ...
    const {loggedIn, setLoggedIn ,user,setUser,accessToken,setAccessToken,isOpen,team, setTeam, roles, setRoles,spaces, setSpaces, inventories, setInventories} =useContext(AppContext);
    ...
    const filteredData = (inventories || []).filter((item) => item.name.toLowerCase().includes(search.toLowerCase()));
