  ...
  return (
    ...
    {addUser ? (
        <div className="add_user_modal">
          <ToastContainer />
          <h3 style={{opacity:"0.75"}}>Add New Asset</h3>
          ...
          <form onSubmit={addNewUser}>
            ...
            <input id="value" onChange={(event) => setContact(event.target.value)} value={contact} type="text" placeholder="Value" />
            <label for="location">Location</label>
            <input id="location" onChange={(event) => setPassword(event.target.value)} value={password} type="text" placeholder="Location" />
